...
const (
	...
	AdService_GetAdsByTitle_FullMethodName  = "/ad.AdService/GetAdsByTitle"
	...
	AdService_ListUsers_FullMethodName      = "/ad.AdService/ListUsers"
...
type AdServiceClient interface {
	...
	ListAds(ctx context.Context, in *FilteredListAdsRequest, opts ...grpc.CallOption) (*ListAdResponse, error)
	GetAd(ctx context.Context, in *GetAdRequest, opts ...grpc.CallOption) (*AdResponse, error)
	GetAdsByTitle(ctx context.Context, in *GetAdsByTitleRequest, opts ...grpc.CallOption) (*ListAdResponse, error)
...
func (c *adServiceClient) ListAds(ctx context.Context, in *FilteredListAdsRequest, opts ...grpc.CallOption) (*ListAdResponse, error) {
...
func (c *adServiceClient) GetAdsByTitle(ctx context.Context, in *GetAdsByTitleRequest, opts ...grpc.CallOption) (*ListAdResponse, error) {
	out := new(ListAdResponse)
	err := c.cc.Invoke(ctx, AdService_GetAdsByTitle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) ListUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListUserResponse, error) {
	out := new(ListUserResponse)
	err := c.cc.Invoke(ctx, AdService_ListUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdServiceServer interface {
	...
	ListAds(context.Context, *FilteredListAdsRequest) (*ListAdResponse, error)
	GetAd(context.Context, *GetAdRequest) (*AdResponse, error)
	GetAdsByTitle(context.Context, *GetAdsByTitleRequest) (*ListAdResponse, error)
...
func (UnimplementedAdServiceServer) ListAds(context.Context, *FilteredListAdsRequest) (*ListAdResponse, error) {
...
func (UnimplementedAdServiceServer) GetAdsByTitle(context.Context, *GetAdsByTitleRequest) (*ListAdResponse, error) {
...
func (UnimplementedAdServiceServer) ListUsers(context.Context, *emptypb.Empty) (*ListUserResponse, error) {
...
func _AdService_ListAds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).ListAds(ctx, req.(*FilteredListAdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdService_GetAdsByTitle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdService_GetAdsByTitle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).GetAdsByTitle(ctx, req.(*GetAdsByTitleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdService_ListUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdServiceServer).ListUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdService_ListUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).ListUsers(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdService_ListUsers_Handler,
		},
		{
			MethodName: "GetUser",
